<?php
require_once 'change_email_view.php';
...
<body background="./icons/hbluredbackground.png">
    ...
    <div class="current-pas" id="currentP" >
        <div class="top-cont">
          ...
          <h2 class="tit" style="margin-top: 10px;margin-bottom: 10px;margin-left: 20px;">Change email</h2>
        </div>
        <form action="change_email_handler.php" method="post">
          <div class="cc">
          ...
          <div class="cc">
            <p class="disc">Please enter new email </p>
            <input type="text" name="email" class="inp-p" placeholder="New email"><br>
          </div>  
          <div class="but-cont">
